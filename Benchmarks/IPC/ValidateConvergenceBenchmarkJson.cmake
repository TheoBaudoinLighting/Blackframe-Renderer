...
require_positive_integer(cpu_wavefront_workers cpu_wavefront_workers)
...
if(cpu_wavefront_workers LESS 2)
    message(FATAL_ERROR "The evaluated Cornell render must use the multithread CPU wavefront path.")
endif()
