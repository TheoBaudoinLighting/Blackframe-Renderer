...
if(TOOLS_ENABLED)
    require_target_role(BlackframeHeadless tool)
    require_target_role(BlackframeTools tool)
    require_target_edge(BlackframeTools BlackframeHeadless order)
endif()
if(BENCHMARKS_ENABLED)
    require_target_role(BlackframeBenchmarks benchmark)
    require_target_role(BlackframeIpcBenchmarks benchmark)
    require_target_edge(BlackframeBenchmarks BlackframeIpcBenchmarks order)
endif()
