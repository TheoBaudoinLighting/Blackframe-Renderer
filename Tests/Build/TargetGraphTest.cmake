...
if(OPENIMAGEIO_ENABLED)
    require_target_role(BlackframeHostImage renderer_io)
    require_target_role(BlackframeOpenImageIo dependency)
    require_target_edge(BlackframeHostImage BlackframeRenderer link)
    require_target_edge(BlackframeHostImage BlackframeOpenImageIo link)
    forbid_target_edge(BlackframeRenderer BlackframeOpenImageIo)
else()
    require_target_absent(BlackframeHostImage)
    require_target_absent(BlackframeOpenImageIo)
endif()
if(STB_ENABLED)
