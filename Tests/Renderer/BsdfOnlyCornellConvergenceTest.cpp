...
using cornell_test::constant_spectrum;
using cornell_test::fixed_wavelengths;
using cornell_test::make_cornell_surfaces;
using cornell_test::make_surface;
using cornell_test::SpectrumFor;
using cornell_test::SurfaceFor;
using cornell_test::WavelengthsFor;
